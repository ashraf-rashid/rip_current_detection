...
def main():
    ...
    yolo.save('temp-model-mish-activation.hdf5')
    # print(yolo.outputs)
    ...
    print('exiting')
    sys.exit(1)
    #yolo.load_weights('./checkpoints_resripdet1_twice_data_aug_100ep/yolov3_custom_Tiny_val_loss_  33.50')
    ...
    mAP_model.load_weights(save_directory) # use keras weights
    get_mAP(mAP_model, testset, score_threshold=TEST_SCORE_THRESHOLD, iou_threshold=TEST_IOU_THRESHOLD)
    yolo.save('Tiny-yolo-object-resripdet1-mish-activation.hdf5')
